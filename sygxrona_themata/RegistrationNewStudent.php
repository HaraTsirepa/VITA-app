...
<link rel="stylesheet" href="css/katax.css"></link>
<body>
...
<h3>Username/password is incorrect.</h3>";
    ...
    $rows = mysqli_num_rows($result);
     ...
     if (!$error) {
        $query = "INSERT into `students` (name,surname,username, password,gender,email, trn_date)
VALUES ('$name','$surname','$username','$password','$gender', '$email', '$trn_date')";
...
<h3>Φόρμα εγγραφής νέου φοιτητή</h3>
<table>
     <tr> 
      <td>Όνομα:</td>
      ...
      <br><br>
       <tr>
        <td>Φύλο:</td>
      <td><input type="radio" name="gender"  value="male" checked> Άνδρας <br><br><input type="radio" name="gender" value="female"> Γυναίκα</td>
      </tr>
      <td>
      <br>
      <br>
